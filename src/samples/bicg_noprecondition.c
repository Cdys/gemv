...
void itsol_solver_init_pars(ITS_PARS *p)
{
    ...
    p->iluk_level = 0;             /* initial level of fill for ILUK  */
...
//        }
        ...
        spmv(balanced_handle,n,CS->RowPtr,CS->ColIdx,CS->Val,pg,vg);
...
//        }
        ...
        spmv(balanced_handle,n,CS->RowPtr,CS->ColIdx,CS->Val,sg,tg);
